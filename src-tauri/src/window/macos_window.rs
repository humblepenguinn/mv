...
#[allow(dead_code)]
pub(crate) fn update_window_title<R: Runtime>(window: WebviewWindow<R>, title: String) {
...
pub(crate) fn setup_traffic_light_positioner<R: Runtime>(window: &WebviewWindow<R>) {
